...
const NewSprintPopup = ({ isOpen, onClose, moduleId, onSprintCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Gắn moduleId vào payload để backend tạo sprint cho module tương ứng
      if (moduleId) {
      ...
      console.log('FormData moduleId:', moduleId);
      // Sử dụng endpoint tạo sprint chung: POST /sprints
