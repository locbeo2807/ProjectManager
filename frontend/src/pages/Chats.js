...
const ChatsContent = () => {
  ...
  // Xác định xem có nên force mở sidebar không (mobile, chưa chọn conversation)
    ...
    <div className={styles.chatContainer}>
      ...
      <div className={styles.chatMainArea}>
        {currentConversation ? (
          ...
          // Chỉ hiển thị empty state nếu KHÔNG phải mobile, nếu không sidebar sẽ full screen
          !isMobile && (
